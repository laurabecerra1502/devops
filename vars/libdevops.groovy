            ...
            stage('Escaneo de la aplicación') {
                steps {
                    script{
                        ...
                        sh 'docker exec owasp zap-full-scan.py -t http://app:8040/ -r reporteowasp.html -I'
                        sh 'docker cp owasp:/zap/wrk/reporteowasp.html reporteowasp.html'
                        sh 'docker cp reporteowasp.html jenkins:/var/jenkins_home/workspace/devops_reto/'
